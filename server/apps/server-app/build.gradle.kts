...
dependencies {
    ...
    implementation(project(":server:ee:libs:embedded:embedded-connection:embedded-connection-rest"))
    implementation(project(":server:ee:libs:embedded:embedded-execution:embedded-execution-mcp-server"))
