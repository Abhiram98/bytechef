...
include("server:ee:libs:embedded:embedded-connection:embedded-connection-rest")
include("server:ee:libs:embedded:embedded-execution:embedded-execution-api")
include("server:ee:libs:embedded:embedded-execution:embedded-execution-mcp-server")
